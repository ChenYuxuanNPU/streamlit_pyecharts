...
def update() -> None:
    ...
    for (year, kind) in load_json_data(folder="database", file_name="database_basic_info")[
    ...
    custom_data_list = set(item[0] for item in load_json_data(folder="database", file_name="database_basic_info")[
        "list_for_update_teacher_info"])
