...
def output_excel_0(title: list, data: list, file_name: str, area_name: str):
    ...
    def add_excel_func():
        ...
        for i, cell in enumerate(
                ["B", "F", "I", "J", "L", "M", "N", "R", "S", "T", "AB", "AE", "AG", "AK", "AM", "AO", "AP", "AR", "AX",
                 "BJ", "BK", "BL", "BM", "BN", "BO"]):
...
if __name__ == '__main__':
    ...
    for item in data:
        ...
        output[item[-8]][item[0]].append(item)
