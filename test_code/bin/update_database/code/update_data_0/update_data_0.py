...
import sqlite3
import os
from test_code.bin.update_data_0 import make_database, data_insert

#设定数据库与表名
database_name = "data_0.db"
table_name = "teacher_info"

def update_data():
    #main函数里的内容不会被调用就直接运行
    print("正在更新数据库（update_data_0.update_database_0.py）")
    ...
    print("数据表创建成功！（update_data_0.update_database.py）")
