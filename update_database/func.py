...
def get_words_dict() -> dict:
    ...
    return {
        "teacher_info_0_2023_word": ['校名', '学校类型', '统一社会信用代码', '姓名', '身份证号', '性别', '民族', '籍贯',
                                     '婚姻状况', '政治面貌', '入党（团）时间', '参加工作前学历', '参加工作前学位',
        ...
        "teacher_info_1_2023_word": ['校名', '学校类型', '统一社会信用代码', '姓名', '身份证号', '性别', '民族', '籍贯',
                                     '婚姻状况', '政治面貌', '入党（团）时间', '参加工作前学历', '参加工作前学位',
        ...
        "school_info_sum_word": ['采集年份', '学段', '合计学校数', '公办学校数', '民办学校数', '合计学生数',
        ...
        "school_info_detail_2023_word": ['采集年份', '学段', '机构代码', '单位名称', '性质', '办学地址',
        ...
        "teacher_info_0_2024_word": ['校名', '学校类型', '统一社会信用代码', '姓名', '身份证号', '性别', '民族', '籍贯',
                                     '婚姻状况', '政治面貌', '入党（团）时间', '参加工作前学历', '参加工作前学位',
                                     '参加工作前毕业院校', '参加工作前毕业院校代码', '参加工作前毕业时间',
                                     '参加工作前所学专业', '最高学历', '最高学位', '最高学历毕业院校',
                                     '最高学历毕业时间', '最高学历所学专业', '参加工作时间', '进入白云教育系统时间',
        ...
        "teacher_info_1_2024_word": ['校名', '学校类型', '统一社会信用代码', '姓名', '身份证号', '性别', '民族', '籍贯',
                                     '婚姻状况', '政治面貌', '入党（团）时间', '参加工作前学历', '参加工作前学位',
                                     '参加工作前毕业院校', '参加工作前毕业时间', '参加工作前所学专业', '最高学历',
                                     '最高学位', '最高学历毕业院校', '最高学历毕业时间', '最高学历所学专业',
                                     '参加工作时间', '进入白云教育系统时间', '入现单位时间', '行政职务',
